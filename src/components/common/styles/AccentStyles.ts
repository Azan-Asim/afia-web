...
export const accentStyles: Record<Accent, AccentStyle> = {
  green: {
    ...
    softSolid: "bg-[rgba(39,174,96,0.24)]",
  },
  blue: {
    ...
    softSolid: "bg-[rgba(45,156,219,0.24)]",
  },
  purple: {
    ...
    softSolid: "bg-[rgba(139,92,246,0.24)]",
  },
  orange: {
    ...
    softSolid: "bg-[rgba(245,158,11,0.24)]",
  },
  pink: {
    ...
    softSolid: "bg-[rgba(236,72,153,0.24)]",
  },
  red: {
    ...
    softSolid: "bg-[rgba(239,68,68,0.24)]",
  },
};
